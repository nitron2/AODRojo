...
Pullfrom = GetInstanceFromDatamodel(Datamodel,"ReplicatedFirst")
Saveto = "src/ReplicatedFirst"
SaveAssetToFilesystem(Pullfrom,Saveto)

Pullfrom = GetInstanceFromDatamodel(Datamodel,"ReplicatedStorage")
Saveto = "src/ReplicatedStorage"
SaveAssetToFilesystem(Pullfrom,Saveto)

Pullfrom = GetInstanceFromDatamodel(Datamodel,"ServerScriptService")
Saveto = "src/ServerScriptService"
SaveAssetToFilesystem(Pullfrom,Saveto)

Pullfrom = GetInstanceFromDatamodel(Datamodel,"ServerStorage")
Saveto = "src/ServerStorage"
SaveAssetToFilesystem(Pullfrom,Saveto)

Pullfrom = GetInstanceFromDatamodel(Datamodel,"StarterGui")
Saveto = "src/StarterGui"
SaveAssetToFilesystem(Pullfrom,Saveto)

Pullfrom = GetInstanceFromDatamodel(Datamodel,"StarterPlayer")
Saveto = "src/StarterPlayer"
SaveAssetToFilesystem(Pullfrom,Saveto)
